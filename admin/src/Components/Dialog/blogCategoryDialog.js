...
import { CLOSE_BlogCategory_DIALOG } from "../../store/blogCategory/types";
import {
  createNewBlogCategory,
  editBlogCategory,
} from "../../store/blogCategory/action.js";
...
const BlogCategoryDialog = (props) => {
  ...
  const handleSubmit = (e) => {
    ...
    if (mongoId) {
      props.editBlogCategory(data, mongoId);
    } else {
      props.createNewBlogCategory(data);
    }
  };
  ...
  return (
    <Fragment>
      <Dialog
        ...
        maxWidth="sm"
      >
        <DialogTitle id="responsive-dialog-title">Blog Category</DialogTitle>
        <IconButton
          style={{
            position: "absolute",
            right: 0,
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group">
                      <label class="float-left">Blog Category Name</label>
                      <input
                        type="text"
                        class="form-control"
