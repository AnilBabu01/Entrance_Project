        ...
        >
          <nav class="sidebar-nav">
            <ul id="sidebarnav">
              ...
              <li class="sidebar-item  ml-3 mb-0 mt-2">
                <a
                ...
                >
                  <i
                    data-feather="home"
                    class="fas fa-folder feather-icon mr-3"
                  ></i>
                ...
                >
                  <li class="sidebar-item mt-3" onClick={handleDrawer}>
                    ...
                    >
                      <i
                        data-feather="home"
                        class="fas fa-square feather-icon pl-2 mr-2"
                      />
                  ...
                  <li class="sidebar-item mt-3" onClick={handleDrawer}>
                    <NavLink to="/admin/sem-list" className={classes.navLink}>
                      <i
                        data-feather="home"
                        class="fas fa-square feather-icon pl-2 mr-2"
                      />
                  ...
                  <li class="sidebar-item mt-3" onClick={handleDrawer}>
                    <NavLink to="/admin/faq-list" className={classes.navLink}>
                      <i
                        data-feather="home"
                        class="fas fa-square feather-icon pl-2 mr-2"
                      />
                  ...
                  <li class="sidebar-item mt-3" onClick={handleDrawer}>
                    ...
                    >
                      <i
                        ...
                        class="fas fa-square feather-icon pl-2 mr-2"
                      />
                      <span class="hide-menu">What client say</span>
                    </NavLink>
                  </li>

                  <li class="sidebar-item mt-3" onClick={handleDrawer}>
                    <NavLink to="/admin/mission" className={classes.navLink}>
                      <i
                        data-feather="home"
                        class="fas fa-square feather-icon pl-2 mr-2"
                      />
                      <span class="hide-menu">Our Mission</span>
                    </NavLink>
                  </li>
                </ul>
              </li>
              ...
              <li class="sidebar-item  ml-3 mb-0 mt-2">
                ...
                >
                  ...
                  <li class="sidebar-item mt-3" onClick={handleDrawer}>
                    <NavLink to="/admin/blog-list" className={classes.navLink}>
                      <i
                        data-feather="home"
              ...
              <li class="sidebar-item  ml-3 mb-0 mt-2">
                ...
                >
                  ...
                  <li class="sidebar-item mt-3" onClick={handleDrawer}>
                    <NavLink to="/admin/units" className={classes.navLink}>
                      <i
                        data-feather="home"
                        class="fas fa-square feather-icon pl-2 mr-2"
                      />
                  ...
                  <li class="sidebar-item mt-3" onClick={handleDrawer}>
                    <NavLink to="/admin/notes" className={classes.navLink}>
                      <i
                        data-feather="home"
                        class="fas fa-square feather-icon pl-2 mr-2"
                      />
                  ...
                  <li class="sidebar-item mt-3" onClick={handleDrawer}>
                    ...
                    >
                      <i
                        ...
                        class="fas fa-square feather-icon pl-2 mr-2"
                      />
                      <span class="hide-menu">Old Questions</span>
                    </NavLink>
                  </li>

                  <li class="sidebar-item mt-3" onClick={handleDrawer}>
                    <NavLink to="/admin/notes-book" className={classes.navLink}>
                      <i
                        data-feather="home"
                        class="fas fa-square feather-icon pl-2 mr-2"
                      />
                  ...
                  <li class="sidebar-item mt-3" onClick={handleDrawer}>
                    ...
                    >
                      <i
                        ...
                        class="fas fa-square feather-icon pl-2 mr-2"
                      />
                      <span class="hide-menu">Practical</span>
                    </NavLink>
                  </li>
                </ul>
              </li>
                ...
                >
                  <li class="sidebar-item mt-3" onClick={handleDrawer}>
                    ...
                    >
                      ...
                      <span class="hide-menu">Test Category</span>
                    </NavLink>
                  </li>
                  <li class="sidebar-item mt-3" onClick={handleDrawer}>
                    <NavLink to="/admin/test" className={classes.navLink}>
                      <i
                        data-feather="home"
                        class="fas fa-square feather-icon pl-2 mr-2"
                      ></i>
              ...
              <li class="sidebar-item ml-3 mb-0">
                ...
                >
                  <i
                    data-feather="grid"
                    class="fas fa-cog feather-icon mr-3"
                  ></i>
                ...
                >
                  <li class="sidebar-item mt-3" onClick={handleDrawer}>
                    <NavLink to="/admin/general-setting" className={classes.navLink}>
                      <i
                        data-feather="home"
                        class="fas fa-square feather-icon pl-2 mr-2"
                      ></i>
                  ...
                  {/* <li class="sidebar-item mt-3" onClick={handleDrawer}>
                    <NavLink to="/admin/credentials" className={classes.navLink}>
                      <i
                        data-feather="home"
                        class="fas fa-square feather-icon pl-2 mr-2"
                      ></i>
                  ...
                  <li class="sidebar-item mt-3" onClick={handleDrawer}>
                    <NavLink to="/admin/privacy-policy" className={classes.navLink}>
                      <i
                        data-feather="home"
                        class="fas fa-square feather-icon pl-2 mr-2"
                      ></i>
                  ...
                  <li class="sidebar-item mt-3" onClick={handleDrawer}>
                    <NavLink to="/admin/terms-of-service" className={classes.navLink}>
                      <i
                        data-feather="home"
                        class="fas fa-square feather-icon pl-2 mr-2"
                      ></i>
                      <span class="hide-menu">Terms of service</span>
                    </NavLink>
                  </li>
                </ul>
              </li>

              <li class="sidebar-item mt-3 mb-4" onClick={handleLogout}>
                <i
                  data-feather="home"
