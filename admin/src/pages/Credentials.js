                      ...
                      <div class="col-lg-12">
                        ...
                        <div class="form-group">
                          ...
                          <input
                            ...
                            value={app_password}
                            onChange={(e) => {
                              setapp_password(e.target.value);
                            }}
                          />
                        </div>
                      </div>
          ...
          <div class="col-xl-6 order-xl-2">
            <div class="card card-profile">
              <div class="card-header">
                <div class="row align-items-center">
                  <div class="col-8">
                    <h3 class="mb-0">Email Body Preview</h3>
                  </div>
                </div>
              </div>
              <div class="card-body">
                <div
                  dangerouslySetInnerHTML={{ __html: mail_template ?? "" }}
                />
              </div>
            </div>
          </div>
